...
class HospitalManagementSystem:
     def __init__(self,root):
          ...
          lbltitle=Label(self.root,text="HOSPITAL MANAGEMENT SYSTEM",bg="blue",fg="white",bd=20,relief=RIDGE,font=("times new roman",50,"bold"),padx=2,pady=6)
          lbltitle.pack(side=TOP,fill=X)
          Dataframe=Frame(self.root,bd=20,relief=RIDGE,padx=20,bg="pink")
          Dataframe.place(x=0,y=130,width=1440,height=400)

          #===========DataFrameLeft==========
          DataFrameLeft=LabelFrame(Dataframe,text="PATIENT INFORMATION",bg="pink",fg="black",bd=12,relief=RIDGE,font=("times new roman",12,"bold"))
          DataFrameLeft.place(x=0,y=5,width=850,height=350)
          lblNameofTablets=Label(DataFrameLeft,bg="pink",text="Name of Tablets:",font=("arial",12,"bold"),padx=2,pady=6)
          ...
          comNameofTablet=ttk.Combobox(DataFrameLeft,textvariable=self.NameofTablets_var,font=("arial",12,"bold"),width=27,state="readonly")
          comNameofTablet["value"]=("Nice","Corona Vacacine","Acetaninophen","Adderall","Ativan","Anlodipine")
          comNameofTablet.current(0)
          comNameofTablet.grid(row=0,column=1)
          lblref=Label(DataFrameLeft,bg="pink",text="Reference No:",font=("arial",12,"bold"),padx=2,pady=6)
          lblref.grid(row=1,column=0,sticky=W)
          txtref=Entry(DataFrameLeft,textvariable=self.Referenceno_var,font=("arial",12,"bold"),width=29)
          txtref.grid(row=1,column=1)
          lblDose=Label(DataFrameLeft,bg="pink",text="Dose:",font=("arial",12,"bold"),padx=2,pady=6)
          lblDose.grid(row=2,column=0,sticky=W)
          txtDose=Entry(DataFrameLeft,textvariable=self.dose_var,font=("arial",12,"bold"),width=29)
          txtDose.grid(row=2,column=1)
          lblNoofTablets=Label(DataFrameLeft,bg="pink",text="No of Tablets:",font=("arial",12,"bold"),padx=2,pady=6)
          lblNoofTablets.grid(row=3,column=0,sticky=W)
          txtNoofTablets=Entry(DataFrameLeft,textvariable=self.nooftablets_var,font=("arial",12,"bold"),width=29)
          txtNoofTablets.grid(row=3,column=1)
          lblIssueDate=Label(DataFrameLeft,bg="pink",text="Issue Date:",font=("arial",12,"bold"),padx=2,pady=6)
          lblIssueDate.grid(row=4,column=0,sticky=W)
          txtIssueDate=Entry(DataFrameLeft,textvariable=self.issuedate_var,font=("arial",12,"bold"),width=29)
          txtIssueDate.grid(row=4,column=1)
          lblExpiryDate=Label(DataFrameLeft,bg="pink",text="Expiry Date:",font=("arial",12,"bold"),padx=2,pady=6)
          lblExpiryDate.grid(row=5,column=0,sticky=W)
          txtExpiryDate=Entry(DataFrameLeft,textvariable=self.expirydate_var,font=("arial",12,"bold"),width=29)
          txtExpiryDate.grid(row=5,column=1)
          lblDailyDose=Label(DataFrameLeft,bg="pink",text="Daily Dose:",font=("arial",12,"bold"),padx=2,pady=6)
          lblDailyDose.grid(row=6,column=0,sticky=W)
          txtDailyDose=Entry(DataFrameLeft,textvariable=self.dailydose_var,font=("arial",12,"bold"),width=29)
          txtDailyDose.grid(row=6,column=1)
          lblSideeffect=Label(DataFrameLeft,bg="pink",text="Side Effect:",font=("arial",12,"bold"),padx=2,pady=6)
          lblSideeffect.grid(row=7,column=0,sticky=W)
          txtSideeffect=Entry(DataFrameLeft,textvariable=self.sideeffect_var,font=("arial",12,"bold"),width=29)
          txtSideeffect.grid(row=7,column=1)
          lblBloodPressure=Label(DataFrameLeft,bg="pink",text="Blood Pressure:",font=("arial",12,"bold"),padx=2,pady=6)
          lblBloodPressure.grid(row=8,column=0,sticky=W)
          txtBloodPressure=Entry(DataFrameLeft,textvariable=self.bloodpressure_var,font=("arial",12,"bold"),width=29)
          txtBloodPressure.grid(row=8,column=1)
          lblStorageDevice=Label(DataFrameLeft,bg="pink",text="Storage Device:",font=("arial",12,"bold"),padx=2,pady=6)
          lblStorageDevice.grid(row=0,column=2,sticky=W)
          txtStorageDevice=Entry(DataFrameLeft,textvariable=self.storagedevice_var,font=("arial",12,"bold"),width=29)
          txtStorageDevice.grid(row=0,column=3)
          lblMedication=Label(DataFrameLeft,bg="pink",text="Medication:",font=("arial",12,"bold"),padx=2,pady=6)
          lblMedication.grid(row=1,column=2,sticky=W)
          txtMedication=Entry(DataFrameLeft,textvariable=self.medication_var,font=("arial",12,"bold"),width=29)
          txtMedication.grid(row=1,column=3)
          lblPatientid=Label(DataFrameLeft,bg="pink",text="Patient Id:",font=("arial",12,"bold"),padx=2,pady=6)
          lblPatientid.grid(row=2,column=2,sticky=W)
          txtPatientid=Entry(DataFrameLeft,textvariable=self.patientid_var,font=("arial",12,"bold"),width=29)
          txtPatientid.grid(row=2,column=3)
          lblNameofPatient=Label(DataFrameLeft,bg="pink",text="Name of Patient:",font=("arial",12,"bold"),padx=2,pady=6)
          lblNameofPatient.grid(row=3,column=2,sticky=W)
          txtNameofPatient=Entry(DataFrameLeft,textvariable=self.nameofpatient_var,font=("arial",12,"bold"),width=29)
          txtNameofPatient.grid(row=3,column=3)
          lblDob=Label(DataFrameLeft,bg="pink",text="DOB:",font=("arial",12,"bold"),padx=2,pady=6)
          lblDob.grid(row=4,column=2,sticky=W)
          txtDob=Entry(DataFrameLeft,textvariable=self.dob_var,font=("arial",12,"bold"),width=29)
          txtDob.grid(row=4,column=3)
          lblPatientaddress=Label(DataFrameLeft,bg="pink",text="Patient Address:",font=("arial",12,"bold"),padx=2,pady=6)
          lblPatientaddress.grid(row=5,column=2,sticky=W)
          txtPatientaddress=Entry(DataFrameLeft,textvariable=self.patientaddress_var,font=("arial",12,"bold"),width=29)
          txtPatientaddress.grid(row=5,column=3)
         

          #==========DataFrameRight===========
          DataFrameRight=LabelFrame(Dataframe,text="PRESCRIPTION",bg="pink",fg="black",bd=12,relief=RIDGE,font=("times new roman",12,"bold"))
          DataFrameRight.place(x=850,y=5,width=520,height=350)
          self.txtPrescription=Text(DataFrameRight,font=("arial",12,"bold"),width=54,height=16,padx=1,pady=4,bg="pink")
          ...
          btnPrescription=Button(Framebutton,command=self.iPresciptionData,text="Prescription",font=("arial",12,"bold"),width=23,bg="green",fg="white")
          btnPrescription.grid(row=0,column=0)
          btnPrescriptiondata=Button(Framebutton,command=self.iPrescription,text="Prescription Data",font=("arial",12,"bold"),width=23,bg="green",fg="white")
          ...
          btnclear=Button(Framebutton,command=self.clear,text="Clear",font=("arial",12,"bold"),width=23,bg="green",fg="white")
          ...
          self.hospital1_table=ttk.Treeview(Detailsframe,column=("NameofTablets","Referenceno","dose","nooftablets","issuedate","expirydate","dailydose","sideeffect","bloodpressure","storagedevice","medication","patientid","nameofpatient","dob","patientaddress"),xscrollcommand=xscroll.set,yscrollcommand=yscroll.set)
     ...
     def iPresciptionData(self):
            conn=mysql.connector.connect(host="localhost",username="root",password="geetha123",database="mydata1")
            my_cursor=conn.cursor()
            my_cursor.execute("insert into hospital1 values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
     ...
     def update(self):
               conn=mysql.connector.connect(host="localhost",username="root",password="geetha123",database="mydata1")
               my_cursor=conn.cursor()
               my_cursor.execute("update hospital1 set NameofTablets=%s,dose=%s,nooftablets=%s,issuedate=%s,expirydate=%s,dailydose=%s,sideeffect=%s,bloodpressure=%s,storagedevice=%s,medication=%s,patientid=%s,nameofpatient=%s,dob=%s,patientaddress=%s where Referenceno=%s",(
                                                                                                                       self.NameofTablets_var.get(),
                                                                                                                       self.dose_var.get(),
                                                                                                                       self.nooftablets_var.get(),
                                                                                                                       self.issuedate_var.get(),
     ...
     def iExit(self):
               iExit= tkinter.messagebox.askyesno("Hospital Management System","Do you want to exit")  
               if iExit>0:
                    self.root.destroy()
                    return          
